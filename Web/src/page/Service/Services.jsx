...
function Services() {
  ...
  return (
    <>
      ...
      <section className="px-5 2xl:max-w-7xl 2xl:mx-auto">
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          {ServiceCard.map((ServicesCard) => (
            <article key={ServicesCard.slug.current}>
              <img src={ServicesCard.mainImage.asset.url} alt={ServicesCard.mainImage.alt} className="h-64 w-[100%]" />
      ...
      <div className="max-w-7xl mx-auto px-5 mb-20 flex items-end rounded justify-end">
